...
ActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "business_dtls", :primary_key => "BusinessId", :force => true do |t|
    t.string "BusinessRep", :limit => 50, :null => false
    t.string "YelpId",      :limit => 50
  end

  create_table "business_infos", :primary_key => "BusinessId", :force => true do |t|
  ...
  add_index "business_infos", ["BusinessId"], :name => "businessId_UNIQUE", :unique => true

  create_table "charity_infos", :primary_key => "CharityId", :force => true do |t|
  ...
  add_index "charity_infos", ["CharityId"], :name => "charityId_UNIQUE", :unique => true

  create_table "supports", :primary_key => "SupportId", :force => true do |t|
  ...
  add_index "supports", ["BusinessId"], :name => "fk_SUPPORT_BUSINESS_INFO"
  add_index "supports", ["CharityId"], :name => "fk_SUPPORT_CHARITY_INFO1"
  add_index "supports", ["SupportId"], :name => "supportId_UNIQUE", :unique => true
  ...
  add_index "transactions", ["SupportId"], :name => "fk_TRANSACTION_SUPPORT1"
  add_index "transactions", ["TransactionId"], :name => "transactionId_UNIQUE", :unique => true
  add_index "transactions", ["UserId"], :name => "fk_TRANSACTION_USER_INFO1"

  create_table "user_infos", :primary_key => "UserId", :force => true do |t|
  ...
  add_index "user_infos", ["UserEmail"], :name => "UserEmail_UNIQUE", :unique => true
  add_index "user_infos", ["UserId"], :name => "userId_UNIQUE", :unique => true
